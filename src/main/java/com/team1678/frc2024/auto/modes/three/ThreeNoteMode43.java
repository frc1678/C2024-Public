...
public class ThreeNoteMode43 extends AutoModeBase {
	...
	public ThreeNoteMode43() {
		TrajectorySet s = TrajectoryGenerator.getInstance().getTrajectorySet();
		startToN4Pickup = logTrajectory(s.R3StartToN4Pickup);
		N4PickupToFarShot = logTrajectory(s.R3N4PickupToStageShot);
		shotToN3Pickup = logTrajectory(s.R3StageShotToN3Pickup);
