...
public class ThreeNoteMode54 extends AutoModeBase {
	...
	public ThreeNoteMode54() {
		...
		shotToN4Pickup = logTrajectory(s.R3FarShotToN4Pickup);
	...
	protected void routine() throws AutoModeEndedException {
		...
		runAction(new ParallelAction(List.of(
				new SwerveTrajectoryAction(shotToN4Pickup, false),
				new SeriesAction(
						new LambdaAction(() -> d.overrideHeading(false)),
