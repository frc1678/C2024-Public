...
public class N4FiveLineMode extends AutoModeBase {
	...
	public N4FiveLineMode() {
		TrajectorySet s = TrajectoryGenerator.getInstance().getTrajectorySet();
		startToN4Pickup = logTrajectory(s.R5StartToN4Pickup);
		N4PickupToNearShot = logTrajectory(s.R5N4PickupToNearShot);
	...
	protected void routine() throws AutoModeEndedException {
		...
		runAction(new ParallelAction(List.of(
				new SwerveTrajectoryAction(N4PickupToNearShot, false),
